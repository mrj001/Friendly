...
namespace Friendly.Library.QuadraticSieve
{
   public class Parameters : IParameters
   {
      private readonly ParameterTableEntry[] _parameters = new ParameterTableEntry[]
      {
         ...
         new ParameterTableEntry(66, 6500, 400_000, 2.35, 17),
         // Values below this line were not present in Ref. B.
         new ParameterTableEntry(72,  6_500, 500_000, 2.35, 17),
         new ParameterTableEntry(78, 10_000, 600_000, 2.35, 17),
         new ParameterTableEntry(84, 12_000, 700_000, 2.35, 17)
      };
